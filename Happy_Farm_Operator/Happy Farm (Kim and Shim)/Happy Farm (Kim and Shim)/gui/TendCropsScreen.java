...
//Tend to crops screen class with GUI
public class TendCropsScreen 
{

	//The tend crops screen Frame
	...
	//The constructor of the TendCropsScreen. With GameCenter incomingManager, the gui can be managed with GameCenter.
	...
	//The function to close the tendCropsScreen Frame.
	public void closeWindow() 
	{
		tendCropsScreenFrame.dispose();
	}
	
	//The function to call closeWindow to close Tend to crop screen.
